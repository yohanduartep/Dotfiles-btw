function ColorMyPencils(color)
    ...
    --base
    local color_base = "#f3eee3"
    --pink
    local color_palepink = "#ff93c9"
    local color_pink = "#ffbede"
    local color_darkpink = "#732d50"
    --comments
    local color_darkerpink = "#5e4350"
    --just green
    local color_green = "#70ba94"
    --just blue
    local color_blue = "#8dc4c8"
    --just yellow
    local color_yellow = "#ffd88b"

    vim.api.nvim_set_hl(0, "@attribute", { fg = color_blue })
    vim.api.nvim_set_hl(0, "@attribute.builtin", { fg = color_blue })
    vim.api.nvim_set_hl(0, "@comment.error", { fg = color_pink })
    ...
    vim.api.nvim_set_hl(0, "@constructor", { fg = color_palepink })
    ...
    vim.api.nvim_set_hl(0, "@function", { fg = color_pink })
    vim.api.nvim_set_hl(0, "@function.builtin", { fg = color_pink })
    vim.api.nvim_set_hl(0, "@function.method", { fg = color_pink })
    vim.api.nvim_set_hl(0, "@interface", { fg = color_blue })
    vim.api.nvim_set_hl(0, "@label", { fg = color_darkpink })
    vim.api.nvim_set_hl(0, "@markup.heading", { fg = color_pink })
    ...
    vim.api.nvim_set_hl(0, "@variable.parameter", { fg = color_green })
    vim.api.nvim_set_hl(0, "@variable.parameter.builtin", { fg = color_green })
    vim.api.nvim_set_hl(0, "Added", { fg = color_green })
    vim.api.nvim_set_hl(0, "BlinkCmpKindClass", { fg = color_pink })
    vim.api.nvim_set_hl(0, "BlinkCmpKindCodeium", { fg = color_blue })
    vim.api.nvim_set_hl(0, "BlinkCmpKindColor", { fg = color_pink })
    vim.api.nvim_set_hl(0, "BlinkCmpKindConstant", { fg = color_pink })
    ...
    vim.api.nvim_set_hl(0, "BlinkCmpKindInterface", { fg = color_pink })
    ...
    vim.api.nvim_set_hl(0, "BlinkCmpKindReference", { fg = color_pink })
    vim.api.nvim_set_hl(0, "BlinkCmpKindSnippet", { fg = color_pink })
    ...
    vim.api.nvim_set_hl(0, "BlinkCmpKindValue", { fg = color_pink })
    vim.api.nvim_set_hl(0, "BlinkCmpKindVariable", { fg = color_pink })
    vim.api.nvim_set_hl(0, "Boolean", { fg = color_base })
    vim.api.nvim_set_hl(0, "Changed", { fg = color_blue })
    vim.api.nvim_set_hl(0, "Character", { fg = color_base })
    ...
    vim.api.nvim_set_hl(0, "CmpItemAbbrMatch", { fg = color_pink, bold = true })
    vim.api.nvim_set_hl(0, "CmpItemKind", { fg = color_darkerpink })
    vim.api.nvim_set_hl(0, "CmpItemKindClass", { fg = color_blue })
    vim.api.nvim_set_hl(0, "CmpItemMatchFuzzy", { fg = color_pink })
    ...
    vim.api.nvim_set_hl(0, "Constant", { fg = color_base })
    ...
    vim.api.nvim_set_hl(0, "DapUIWatchesEmpty", { fg = color_pink })
    vim.api.nvim_set_hl(0, "DapUIWatchesValue", { fg = color_darkpink })
    vim.api.nvim_set_hl(0, "Debug", { fg = color_pink })
    ...
    vim.api.nvim_set_hl(0, "DiagnosticError", { fg = color_pink })
    ...
    vim.api.nvim_set_hl(0, "DiagnosticUnderlineOk", { sp = color_pink, underline = true })
    ...
    vim.api.nvim_set_hl(0, "Directory", { fg = color_pink})
    ...
    vim.api.nvim_set_hl(0, "Float", { fg = color_base })
    ...
    vim.api.nvim_set_hl(0, "Function", { fg = color_pink })
    vim.api.nvim_set_hl(0, "FunctionName", { fg = color_pink })
    vim.api.nvim_set_hl(0, "IblScope", { fg = color_pink })
    vim.api.nvim_set_hl(0, "Identifier", { fg = color_pink })
    ...
    vim.api.nvim_set_hl(0, "MatchParen", { fg = color_darkerpink, bg = color_pink })
    ...
    vim.api.nvim_set_hl(0, "MiniStarterSection", { fg = color_pink })
    ...
    vim.api.nvim_set_hl(0, "NeotestAdapterName", { fg = color_pink })
    vim.api.nvim_set_hl(0, "NeotestDir", { fg = color_blue })
    vim.api.nvim_set_hl(0, "NeotestExpandMarker", { fg = color_green })
    vim.api.nvim_set_hl(0, "NeotestFailed", { fg = color_pink })
    vim.api.nvim_set_hl(0, "NeotestFile", { fg = color_blue })
    vim.api.nvim_set_hl(0, "NeotestIndent", { fg = color_darkpink })
    vim.api.nvim_set_hl(0, "NeotestMarked", { fg = color_pink })
    vim.api.nvim_set_hl(0, "NeotestNamespace", { fg = color_pink })
    vim.api.nvim_set_hl(0, "NeotestPassed", { fg = color_green })
    vim.api.nvim_set_hl(0, "NeotestRunning", { fg = color_palepink })
    vim.api.nvim_set_hl(0, "NeotestSkipped", { fg = color_blue })
    vim.api.nvim_set_hl(0, "NeotestTarget", { fg = color_pink })
    ...
    vim.api.nvim_set_hl(0, "Number", { fg = color_palepink })
    ...
    vim.api.nvim_set_hl(0, "Question", { fg = color_pink })
    ...
    vim.api.nvim_set_hl(0, "Search", { fg = color_base, bg = color_pink })
    ...
    vim.api.nvim_set_hl(0, "SnacksPickerMatch", { fg = color_pink, bold = true})
    vim.api.nvim_set_hl(0, "Special", { fg = color_base })
    vim.api.nvim_set_hl(0, "SpecialChar", { fg = color_base })
    ...
    vim.api.nvim_set_hl(0, "String", { fg = color_green })
    ...
    vim.api.nvim_set_hl(0, "TelescopePreviewTitle", { fg = color_pink })
    vim.api.nvim_set_hl(0, "TelescopePromptMatching", { fg = color_pink })
    vim.api.nvim_set_hl(0, "TelescopePromptPrefix", { fg = color_blue })
    vim.api.nvim_set_hl(0, "TelescopeSelection", { bg = color_darkerpink })
    vim.api.nvim_set_hl(0, "TelescopeSelectionCaret", { fg = color_pink, bg = color_darkerpink })
    vim.api.nvim_set_hl(0, "TelescopeTitle", { fg = color_pink, bold = true })
    ...
    vim.api.nvim_set_hl(0, "TreeSitterContextLineNumber", { fg = color_pink, bg = color_darkerpink })
    vim.api.nvim_set_hl(0, "TroubleNormal", { fg = color_base, bg = color_darkerpink })
    vim.api.nvim_set_hl(0, "Type", { fg = color_pink })
    vim.api.nvim_set_hl(0, "Underlined", { fg = color_pink, underline = true })
    vim.api.nvim_set_hl(0, "Variable", { fg = color_base })
